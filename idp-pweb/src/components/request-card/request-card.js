...
export default function RequestCard({ bookmarkPost, request }) {
    return (
            ...
            { request && 
                <div className=" rounded overflow-hidden shadow-lg">
                            ...
                            <span className="cursor-pointer">
                                {
                                    ...
                                    ? <i className="fa fa-bookmark" onClick={() => bookmarkPost(request)}></i>
                                    : <i className="fa fa-bookmark-o" onClick={() => bookmarkPost(request)}></i>
                                }
                            </span>
                        </div>
                    ...
                    <div className="pb-2 link-card-container">
                        <Link className="px-6 pb-2 more-info-btn" to={{pathname: `/more-info/request/${request.id}`}}> More info </Link>
                    </div>
                </div> 
            }
        </div>
